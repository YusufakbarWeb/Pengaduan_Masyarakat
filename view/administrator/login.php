...
//get data
$acount = mysqli_query($conn,"SELECT * FROM petugas WHERE username ='$username' AND level = '$level'");
...
if(mysqli_num_rows($acount) === 1){
    ...
    if($password == $data['password']){
        ...
        if($level == "petugas"){
            header ('location:../petugas/verifikasi_tanggapan.php');
        }elseif($level == "admin"){
                ...
                <div class="p-5">
                    ...
                    <form class="registrasi" method="post" action="">
                        <div class="form-group">
                            ...
                            <hr>
                            <div class="text-center">
                            <a class="small" href="../../index.php">Login Sebagai Masyarakat</a>
